...
type RestockPrediction struct {
	...
	ProductName          string    `gorm:"column:prodPrediuct_name;type:varchar(255);not null"`
	ctionDate     	     *time.Time `gorm:"column:prediction_date;type:date;not null;index:idx_restock_store_product_date,unique"`
