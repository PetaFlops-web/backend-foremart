...
|---|---|---|---|---|
| `store_id` | string | ✅ | — | ID toko yang ingin diprediksi |
| `product_id` | string | ❌ | — | ID produk. Kosong = prediksi **seluruh** produk toko |
| `forecast_date` | string (RFC3339) | ❌ | besok | Tanggal target prediksi (`YYYY-MM-DDT00:00:00Z`). Harus besok atau setelahnya |
...
#### Rumus Rekomendasi Restock

```
days_ahead           = forecast_date − hari ini (dalam hari kalender)
recommended_restock  = (daily_sales × days_ahead) − current_stock
```
